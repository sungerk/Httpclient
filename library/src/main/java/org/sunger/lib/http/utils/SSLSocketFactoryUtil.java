...
/**
 * Created by sunger on 2015/9/10.
 */

/**
 * SSLSocketFactory 工具类，用于简化SSLSocketFactory创建，用于https请求
 */
public class SSLSocketFactoryUtil {
     ...
     * @throws Exception
     */
    public static SSLSocketFactory create(InputStream[] certificates, InputStream bksFile, String password) throws Exception {
        CertificateFactory certificateFactory = CertificateFactory.getInstance("X.509");
